                  ...
                  <div className="mt-6 grid gap-4 lg:gap-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                      <div>
                        ...
                        <input
                          ...
                          value={feedbackForm.values.firstname}
                          name="firstname"
                          id="firstname"
                          className="py-3 px-4 block w-full bg-white border-2 border-black rounded-lg text-sm"
                        />{feedbackForm.touched.firstname && (
                          <small className="text-red">{feedbackForm.errors.firstname}</small>
                        )}
                      </div>
                      <div>
                        <label
                        ...
                        <input
                          type="text"
                          onChange={feedbackForm.handleChange}
                          value={feedbackForm.values.lastname}
                          name="lastname"
                          id="lastname"
                          className="py-3 px-4 block w-full bg-white border-2 border-black rounded-lg text-sm"
                        />{feedbackForm.touched.lastname && (
                          <small className="text-red">{feedbackForm.errors.lastname}</small>
                        )}
                      </div>
                    </div>
                    {/* End Grid */}
                    <div>
                      ...
                      />{feedbackForm.touched.email && (
                        <small className="text-red">{feedbackForm.errors.email}</small>
                      )}
                    </div>
                    {/* Grid */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          onChange={feedbackForm.handleChange}
                          value={feedbackForm.values.company}
                          name="company"
                          id="company"
                          className="py-3 px-4 block w-full bg-white border-2 border-black rounded-lg text-sm"
                        />{feedbackForm.touched.company && (
                          <small className="text-red">{feedbackForm.errors.company}</small>
                        )}
                      </div>
                      <div>
                        <label
                        ...
                        <input
                          type="text"
                          onChange={feedbackForm.handleChange}
                          value={feedbackForm.values.subject}
                          name="subject"
                          id="subject"
                          className="py-3 px-4 block w-full bg-white border-2 border-black rounded-lg text-sm "
                        />{feedbackForm.touched.subject && (
                          <small className="text-red">{feedbackForm.errors.subject}</small>
                        )}
                      </div>
                    </div>
                    {/* End Grid */}
