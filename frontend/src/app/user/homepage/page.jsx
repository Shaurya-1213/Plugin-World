      ...
      <main>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-8 py-8 flex-auto">
                    ...
                    Our Plugins will make  it easy to add features to your site, such as payment gateway or cart.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative  flex flex-col min-w-0 break-words bg-voilet-800 w-full mb-6 shadow-lg rounded-lg bg-pink-600">
                  ...
                  <blockquote className="relative  p-8 mb-4">
                    ...
                    <p className="text-md font-light mt-2 text-white">
                      We are working hard to make your work easy. Our team of experienced developers and designers work closely with our clients to understand their needs.
                    </p>
                  </blockquote>
                </div>
              </div>
        ...
        <section className="relative py-20">
          ...
          >
            ...
            >
              <polygon
                className="text-voilet-300 fill-current"
            ...
            <div className="items-center flex flex-wrap">
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  ...
                  We understand that developers need tools created by other developers. That's why we offer a community driven platform where you can find plugins created by developers.
                  </p>
                  <ul className="list-none mt-6">
                    ...
                    <li className="py-2">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="text-gray-600">Completely safe</h4>
                        </div>
                      </div>
                    </li>
                    <li className="py-2">
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="text-gray-600">Easy-to-use</h4>
                        </div>
                      </div>
                    </li>
                  </ul>
        ...
        <section className="relative block py-24 lg:pt-0 bg-gray-900">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center lg:-mt-64 -mt-48">
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-voilet-800">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="text-center mt-6">
                      <button
                        className="bg-white text-black active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1"
                        type="button"
                        style={{ transition: "all .15s ease" }}
                      >
                        Send Message
