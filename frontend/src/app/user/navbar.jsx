...
export const Nav = () => {
  ...
  return (
    <div className="">
  {/* nav - start */}
  <nav className="sticky justify-center bottom-0 mx-auto w-full sm:max-w-md">
    <a
      href="#"
      className="absolute -top-7 left-1/2 flex h-14 w-14 -translate-x-1/2 items-center justify-center rounded-3xl bg-voilet-300 text-white shadow-lg transition duration-100 hover:bg-purple sm:-top-8 sm:h-16 sm:w-16"
    >
      <svg
        className="h-6 w-6"
    ...
    <div className="text-voilet-300 transition duration-100 hover:text-purple">
      <a
        href="#"
      ...
      <a
        href="/"
        className=" flex flex-col items-center text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600 "
      >
