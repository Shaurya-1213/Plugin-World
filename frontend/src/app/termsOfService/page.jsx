...
const termsOfService = () => {
  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="mb-10 md:mb-16">
      ...
      </p><p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
        This is a section of some simple filler text, also known as placeholder
        text. It shares some characteristics of a real written text but is
        random or otherwise generated.
      </p><p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
    ...
    <div className="grid gap-8 sm:grid-cols-2 sm:gap-y-10 xl:grid-cols-3">
      ...
      <div className="relative rounded-lg bg-gray-100 p-5 pt-8">
        ...
        </span><span className="absolute -top-4 left-4 inline-flex h-8 w-8 items-center justify-center rounded-full bg-indigo-500 text-white">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            viewBox="0 0 20 20"
