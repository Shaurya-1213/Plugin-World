  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <form className="mx-auto max-w-lg rounded-lg border">
      <div className="flex flex-col gap-4 p-4 md:p-8">
        ...
        <button className="block rounded-lg bg-darkblue px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base">
          Log in
        </button>
        ...
        <button className="flex items-center justify-center gap-2 rounded-lg bg-blue px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-blue-300 transition duration-100 hover:bg-blue-600 focus-visible:ring active:bg-blue-700 md:text-base">
          <svg
