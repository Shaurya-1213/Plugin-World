...
const About = () => {
  ...
  <div className="mx-auto max-w-screen-md px-4 md:px-8">
    <h1 className="mb-4 text-center text-2xl font-bold text-black sm:text-3xl md:mb-6">
    ...
    <p className="mb-6 text-black sm:text-lg md:mb-8">
      ...
      <a
        href="#"
        className="text-black underline transition duration-100 hover:text-indigo-600 active:text-indigo-700"
      >
        random
      </a>{" "}
      or otherwise generated. It may be used to display a sample of fonts or
    ...
    <ul className="mb-6 list-inside list-disc text-black sm:text-lg md:mb-8">
    ...
    <blockquote className="mb-6 border-l-4 pl-4 italic text-black sm:text-lg md:mb-8 md:pl-6">
      “This is a section of some simple filler text, also known as placeholder
      text. It shares some characteristics of a real written text but is random
