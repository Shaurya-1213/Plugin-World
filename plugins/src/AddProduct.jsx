        ...
        <div className="max-w-2xl px-4 py-8 mx-auto lg:py-16">
          ...
          <form action="#" onSubmit={productForm.handleSubmit}>
            ...
            <div className="flex items-center justify-center space-x-4">
              <button
                type="submit"
                className="text-white bg-black hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-xl px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
                Add Plugin
              </button>
            </div>
      ...
      <div className="bg-white rounded-xl shadow ">
        ...
        <div className="pt-0 p-4 sm:pt-0 sm:p-7">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              <label className="sr-only text-black">Product photo</label>
              <div className="grid sm:flex sm:items-center sm:gap-x-5">
                ...
                <div className="mt-4 sm:mt-auto sm:mb-1.5 flex justify-center sm:justify-start gap-2">
                  <button
                    type="button"
                    className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-blue-500 text-white"
                  >
                    <svg
                  ...
                  <button
                    type="button"
                    className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-red-600 text-white shadow-sm "
                  >
                    Delete
                  </button>
                </div>
